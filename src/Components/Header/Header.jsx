...
const Header = () => {
  return (
    <header className="max-w-[1230px] mt-10 md:ml-20 mx-auto flex flex-col-reverse md:flex-row items-center justify-between mt-6 md:mt-12 lg:mt-20 px-4 sm:px-6 md:px-8">
      {/* Left Text Section */}
      <section className="text-center md:text-left md:w-1/2 lg:w-[45%]">
      ...
      {/* Right Image Section */}
      <figure className="flex justify-center md:w-1/2 lg:w-[55%] mt-6 md:mt-0">
        <img
          className="w-full sm:w-[90%] md:w-[90%] lg:w-[75%] md:ml-24 max-w-[400px] sm:max-w-[500px] bg-[#FFDAD6]"
          src={hero}
